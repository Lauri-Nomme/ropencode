...
impl Default for Theme {
    fn default() -> Self {
        Theme {
            ...
            panel_bg: Color::Rgb(55, 71, 79),
            status_bar_bg: Color::Rgb(38, 50, 56),
            user_color: Color::Rgb(137, 221, 255),
            assistant_color: Color::Rgb(238, 255, 255),
            error_color: Color::Rgb(240, 113, 120),
            thinking_color: Color::Rgb(84, 110, 122),
            accent_color: Color::Rgb(130, 170, 255),
            selection_bg: Color::Rgb(55, 71, 79),
            heading_fg: Color::Rgb(130, 170, 255),
            link_fg: Color::Rgb(137, 221, 255),
            blockquote_fg: Color::Rgb(84, 110, 122),
            inline_code_fg: Color::Rgb(195, 232, 141),
            inline_code_bg: Color::Rgb(38, 50, 56),
            code_bg: Color::Rgb(38, 50, 56),
